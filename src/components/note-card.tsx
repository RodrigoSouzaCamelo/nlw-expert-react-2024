...
export function NoteCard({ date, content }: NoteCardProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger className='roundend-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
